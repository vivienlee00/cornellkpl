data = [
  ...
  },
  {
    ...
    major:
      "Psychology - transferred to Alpha Chapter at SUNY Binghamton University",
    nickname: "Indulge",
    semester: "Fall 2003",
    year: 2006,
  },
  ...
  },
  {
    ...
    line_number: 60,
    little:
      "Hannah *Periwinkle* Chung (γAA), Vivian *Almandine* On (UNR Charter), Agnes *Euthymia* Shin, Nuri *eevee* Kim",
    major: "Biological Sciences",
  ...
  },
  {
    ...
    line_number: 94,
    little:
      "Teresa *ashe* Huang, Michelle *léda* Huang, Madelyn *imogen* Kim, Kelly *sappho* Foo, Vivien *clytemnestra* Lee",
    major: "Mechanical Engineering",
    nickname: "Evangeline",
    semester: "Spring 2015",
    year: 2018,
  ...
  },
  {
    ...
    line_number: 114,
    little:
      "Jennifer *Alaïa* Nguyen (γAZ), Angela *Belamoda* Zhu, Joyee *Millésime* Ng, Leia *Lalique* Chung",
    major: "Information Science",
    nickname: "Belle Äme",
    semester: "Spring 2016",
    year: 2019,
  ...
  },
  {
    big: "Celina *MEI* Kim",
    description:
      "playing with my cat and dog, drinking chai tea lattes, eating poke, sleeping",
    ethnicity: "Chinese",
    first_name: "Jessica",
  ...
  },
  {
    ...
    line_number: 204,
    little:
      "Amber *roborare* Prasad, Neen Yada *resalire* Tangcharoenmonkong, Kat *ciételle* Wei",
    major: "Animal Science",
    nickname: "audax",
    semester: "Fall 2021",
    year: 2024,
  ...
  },
  {
    ...
    last_name: "Han",
    line_number: 209,
    little: "Milly *iriséa* Miao, Sandra *santero* Tang",
    major: "Art History and College Scholar Program",
    nickname: "cloudbreak",
    semester: "Spring 2022",
    year: 2025,
  ...
  },
  {
    ...
    description:
      "grabbing a medium less ice lychee black tea w/ herbal jelly at kung fu tea 😋",
    ethnicity: "Chinese",
    first_name: "Vanessa",
    hometown: "New York, NY",
    last_name: "Tam",
    line_number: 218,
    little: "Polly *cerafini* Wang",
  ...
  },
  {
    ...
    last_name: "Wong",
    line_number: 223,
    little: "Kaitlyn *Ofrésia* Nam, Xixi *Panope* Wang",
    major: "Human Biology, Health, and Society",
    nickname: "Oyédo",
    semester: "Fall 2023",
    year: 2026,
